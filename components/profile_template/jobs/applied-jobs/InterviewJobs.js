...
const InterviewJobs = () => {
  ...
  const apiUrl = `${API}/users/appliedJobs?page=${page}&pageSize=6&fields=id,name,companies,jobType,location,created,closeDate,interview&filter=interview:eq:true`
  ...
  const refreshJobs = () => {
    ...
    axios
      .get(
        `${API}/users/appliedJobs?page=1&pageSize=6&fields=id,name,companies,jobType,location,created,closeDate,interview&filter=interview:eq:true`,
        config
      )
      .then((res) => {
